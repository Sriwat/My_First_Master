...
class FeedViewController: UIViewController {
    ...
    func setupTableViewDummyData(){
        let news:News = News(id:1,title: "iOS", description: "Error lets stop doing thisaaaaaaaaaaaaaaaaaaaa", iconImage: #imageLiteral(resourceName: "cheese_flat"), author: "พยุต", view: 2, createDate: "29/06/60",category: "Tech")
        var news2:News = News(id: 2,title: "Android", description: "555555555555555555555555555555555+", iconImage: #imageLiteral(resourceName: "cat"), author: "แจ็ค", view: 99999, createDate: "29/06/60",category: "Sport")
